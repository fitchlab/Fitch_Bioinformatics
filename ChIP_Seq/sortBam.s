...
printf "Removing duplicates for $bamfile \n"
...
bedToBam -i ${bamfile}.bed -g /scratch/pf887/chipseq/NewChIPData/ChIPseq_Ercan_git_clone/src/Caenorhabditis_elegans.WBcel235.dna.toplevel.fa.fai > $bamfile

#printf "Sorting $bamfile\n"
samtools sort -o ${bamfile}_sorted $bamfile

cp ${bamfile}_sorted ${bamfile}_sort
