...
sub loadBed {
    ...
    my $bbfile = $file;
    $bbfile =~ s/.bed/.bb/;
        system("bedToBigBed -as=/scratch/pf887/chipseq/NewChIPData/ChIPseq_Ercan_git_clone/src/narrowPeak.as -type=bed6+4 $file /scratch/cgsb/ercan/annot/ce10_chromInfo.txt $bbfile");
    system("rm $temp");
}
